...
OptionsMenu::OptionsMenu(StateMainMenu& state_main_menu, GameSettings& m_game_settings)
{
	...
	vec_checkbox.push_back(make_unique<UI::CheckBox>(System::CreateShape(v2f(poz_checkbox_x, poz_checkbox_y + size_checkbox * 0 * DF), size_checkbox_xy, t_checkbox), "Music", m_game_settings_ptr->GetMusicOn(), *m_game_settings_ptr));
	vec_scroll.push_back(make_unique<UI::Scroll>(v2f(poz_checkbox_x + 200, poz_checkbox_y + size_checkbox * 0 * DF), v2f(300, 50), "Music", m_game_settings_ptr->GetMusicVolume()));
	...
	vec_checkbox.push_back(make_unique<UI::CheckBox>(System::CreateShape(v2f(poz_checkbox_x, poz_checkbox_y + size_checkbox * 1 * DF), size_checkbox_xy, t_checkbox), "Sound", m_game_settings_ptr->GetSoundOn(), *m_game_settings_ptr));
	vec_scroll.push_back(make_unique<UI::Scroll>(v2f(poz_checkbox_x + 200, poz_checkbox_y + size_checkbox * 1 * DF), v2f(300, 50), "Sound", m_game_settings_ptr->GetSoundVolume()));
